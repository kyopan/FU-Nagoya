...
| 基板名 | 役割 | LED数 | センサー | DCDC | 真鍮ワイヤー | 板厚 | 色 |
|--------|------|-------|---------|------|-------------|------|-----|
| **Grid Ring (GR)** | IRマトリクスセンサ + 照明 | 48個（表24＋裏24） | Grid-EYE (8×8 IR) | 3.3V 100mA | 6本 | **1.0mm** | **白** |
| **Pitch Ring (PR)** | メイン制御基板 + 照明 | 48個（表24＋裏24） | - | 5V 2A | 12本 | **1.6mm** | **白** |
| **Compass Ring (CR)** | IMUセンサ + 照明 | 48個（表24＋裏24） | GY-85 (6軸IMU) | 3.3V 100mA | 6本 | **1.0mm** | **白** |
| **合計** | - | **144個** | - | - | **24本** | - | - |

**構造**: Pitch Ringを中心に、Grid RingとCompass Ringが真鍮ワイヤーで接続される3層構造

**スルーホール接続方式**: PRのNeoPixel貫通穴を削除し、W2_3/W4_5/W_6でスルーホール接続

**重要な仕様**:
- **GR/CR共用基板**: 同じ基板の表裏を使い回し（板厚: 1.0mm）
- **PR**: 独立した基板（板厚: 1.6mm、より頑丈な構造）
- **基板色**: 全て白色
...
| 基板名 | 板厚 | 備考 |
|--------|------|------|
| **Grid Ring (GR)** | **1.0mm** | GR/CR共用基板の表面 |
| **Compass Ring (CR)** | **1.0mm** | GR/CR共用基板の裏面 |
| **Pitch Ring (PR)** | **1.6mm** | より頑丈な構造（RP2040、コネクタ搭載） |
