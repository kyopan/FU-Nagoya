...
|--------|------|-------|---------|------|-------------|
| **Grid Ring** | IRマトリクスセンサ + 照明 | 48個（表24＋裏24） | Grid-EYE (8×8 IR) | 3.3V 100mA | 6本 |
| **Pitch Ring** | メイン制御基板 + 照明 | 48個（表24＋裏24） | - | 5V 2A | 12本 |
| **GY85 Ring** | IMUセンサ + 照明 | 48個（表24＋裏24） | GY-85 (6軸IMU) | 3.3V 100mA | 6本 |
| **合計** | - | **144個** | - | - | **24本** |
