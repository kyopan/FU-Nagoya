...
// ---------------------------------------------------------
// コンパイル時定数（旧 #define）- ESP32-S3 pin configuration
// ---------------------------------------------------------
inline constexpr uint8_t NEOPIXEL_PIN = 48;  // ESP32-S3 onboard RGB LED (typically GPIO48)
inline constexpr uint8_t U2_SLAVE_ADDRESS = 0x08;
inline constexpr uint8_t PIN_ONBOARD_LED = 48;  // ESP32-S3 RGB LED
inline constexpr uint8_t PIN_U1_SDA = 8;   // I2C to U2 (SDA)
inline constexpr uint8_t PIN_U1_SCL = 9;   // I2C to U2 (SCL)
inline constexpr uint8_t PIN_U1_RX = 17;   // UART1 to U3 (RX)
inline constexpr uint8_t PIN_U1_TX = 18;   // UART1 to U3 (TX)
